...
//		
//		OFScene intro = new OFScene(); //title and text block of story
//		
//		//objects of the scene
//		OFCenter intro_title = new OFCenter( "████████████████████ OPERATION FUTURE ████████████████████" );
//		OFText intro_text = new OFText( "", 1, 3 ); //wrapper (data, x,y)
//		
//		intro.addObjects( new OFAnimatable[] { intro_title, intro_text } );
//		
//		OFCommandLine game = new OFCommandLine( animator, frameDone, intro ); //intro is starting scene
//		
