...
public class PacificOcean extends Location implements State {
	...
	public void printStatus() {
		...
		ui.println("          . _..::__:  ,-\"-\"._       |]       ,     _,.__              \n"
				...
				+ "         |        "+ui.colorText("\u25C9 Night city", 51,204,51)+"    _)_.\\\\._<> {}              _,' /  '   \n"     //green 51,204,51
				+ "         `.         /          [_/_'` `\"(                <'}  )       \n"
				+ "          \\\\    .-. )          /   `-'\"..'  "+ui.colorText("\u25C9 HQ", 192,192,192)+"            _)  '        \n"
				+ "            \\  (  `(          /         `:\\  > \\  ,-^.  /' '          \n"
				+ "             `._,   \"\"        | "+ui.colorText("Sahara Desert", 51,204,51)+"   \\`'   \\|   ?_)  {\\          \n"
				+ "                `=.---.       `._._       ,'     \"`  |' ,- '.         \n"
				+ "                  |    `-._        |     /          `:`<_|=--._       \n"
				+ "   "+ ui.colorText("Pacific Ocean", 0,0,255) +"  (        >       .     | ,          `=.__.`-'\\      \n"
				+ "                   `.     /        |     |{|              ,-.,\\     . \n"
				+ "                    |   ,'          \\   / `'            ,\"     \\      \n"
				+ "                    |  /             |_'                |  __  /      \n"
